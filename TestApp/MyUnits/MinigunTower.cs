...
{
    public class MinigunTower : IUnit, IFire, IRotation
    {
        ...
        public MinigunTower() : this(DEFAULT_POSITION_X, DEFAULT_POSITION_Y, DEFAULT_DIRECTION, DEFAULT_AMMO)
        { }

        public MinigunTower(double x, double y, double direction, int ammo)
        {
